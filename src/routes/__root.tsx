    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center glass-card rounded-2xl p-10">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-gradient-luxe px-5 py-2.5 text-sm font-medium text-primary-foreground transition hover:opacity-90"
          >
            Go home
          </Link>
        </div>
      ...
      <div className="max-w-md text-center glass-card rounded-2xl p-10">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          <button
            ...
            className="inline-flex items-center justify-center rounded-md bg-gradient-luxe px-4 py-2 text-sm font-medium text-primary-foreground"
          >
            Try again
          </button>
        </div>
